...
export default function SeoAuditPage() {
  ...
  return (
    <>
      ...
      {/* CTA */}
      <CTABanner
        title="Find Out What Is Holding Your Rankings Back"
        description="Request a free preliminary site health check and see the opportunities hiding in your SEO."
        buttonText="Request Your Free Health Check"
        buttonHref="/contact"
      />
    </>
  );
