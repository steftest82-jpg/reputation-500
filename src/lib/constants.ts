    ...
    children: [
      { label: 'Market Activation', href: '/services/market-activation' },
      {
        ...
        children: [
          ...
          { label: 'Brand Mentions', href: '/services/for-individuals/brand-mentions' },
          { label: 'Reputation Monitoring', href: '/services/for-individuals/reputation-monitoring' },
        ],
      },
      {
        ...
        children: [
          ...
          { label: 'Reputation Monitoring', href: '/services/for-businesses/reputation-monitoring' },
        ],
      },
      {
        label: 'SEO',
